METADATA_SCHEMA = {
    ...
    "identifying_person": {
        "label": "Identifierande person(er):",
        "identifier": "Identifierande person(er):",
        "examples": [
            "Sven Andersson",
    ...
    "situation": {
        "label": "Sammanhang som bilden togs:",
        "identifier": "Sammanhang som bilden togs:",
        "examples": [
    ...
    "notes": {
        ...
        "examples": [
            ...
            "Personerna är identifierade av Sven Andersson.",
        ],
    },
}
